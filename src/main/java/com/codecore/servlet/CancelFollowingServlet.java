...
@WebServlet(name = "CancelFollowingServlet",urlPatterns = {"/CancelFollowingServlet"})
		...
		AttentionDao attentionDao=new AttentionDao();
 		...
 		String type=request.getParameter("type");
 		 if("following".equals(type)){
 			response.sendRedirect("/ShowFollowingServlet");
 	    }
 	    else if("friend".equals(type)){
 	    	response.sendRedirect("/ShowFriendsServlet");
 	    }		
	}
}
